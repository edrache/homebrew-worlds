...
Each skill lives in `Skills/<skill-name>/SKILL.md` and contains full instructions for the task.
Read the relevant SKILL.md before executing any skill-based workflow.
...
- Scripts: `Skills/homebrew-playbook-sheet/scripts/`
...
- Scripts: `Skills/homebrew-web-presenter/scripts/`
...
- Skill instructions are in `Skills/<skill-name>/SKILL.md` – always read them before executing
